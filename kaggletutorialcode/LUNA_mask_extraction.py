# -*- coding: utf-8 -*-
"""
Created on Sat Feb 25 11:33:43 2017
...
df_node = pd.read_csv(luna_path+"annotations.csv")#location of the annotations.csv
    ...
    if mini_df.shape[0]>0: # some files may not have a nodule--skipping those 
        ...
        for node_idx, cur_row in mini_df.iterrows():       
            ...
            for i, i_z in enumerate(np.arange(int(v_center[2])-nodule_max,
                ...
                #try:
                    #slice_diam = np.sqrt((diam/2)**2-(np.abs(i_z-v_center[2])*spacing[2])**2)*2
                #except: slice_diam = 0
