# -*- coding: utf-8 -*-
"""
Created on Sat Feb 25 11:35:02 2017
...
all_files = all_files = os.listdir(working_path)
file_list = [working_path + i for i in all_files if 'lungmask_' in i]
